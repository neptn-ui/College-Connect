...
export const StudentDashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Welcome Banner */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 rounded-2xl bg-linear-to-r from-brand/10 to-[#958ef0]/10 border border-brand/20">
        <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Attendance Stat */}
        <Card hoverEffect={true} padding="sm" className="flex items-center gap-4 relative overflow-hidden">
          ...
          <div>
            ...
            <span className="text-2xl font-bold text-text-primary mt-0.5">{attendancePercent}%</span>
          </div>
        ...
        {/* GPA Stat */}
        <Card hoverEffect={true} padding="sm" className="flex items-center gap-4">
          <div className="p-3 rounded-xl bg-purple-500/10 text-purple-500">
            <Award className="w-6 h-6" />
          </div>
          <div>
            <span className="text-xs text-text-secondary font-medium uppercase tracking-wider block">SGPA</span>
            <span className="text-2xl font-bold text-text-primary mt-0.5">8.84</span>
          </div>
        </Card>
        ...
        <Card hoverEffect={true} padding="sm" className="flex items-center gap-4">
          ...
          <div>
            ...
            <span className="text-2xl font-bold text-text-primary mt-0.5">{completedCount} Completed</span>
          </div>
        </Card>
        ...
        <Card hoverEffect={true} padding="sm" className="flex items-center gap-4">
          ...
          <div>
            ...
            <span className="text-2xl font-bold text-text-primary mt-0.5">{upcomingClasses.length} Scheduled</span>
          </div>
        </Card>
      </div>
