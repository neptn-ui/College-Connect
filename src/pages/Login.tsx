    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-gradient-to-br from-brand/5 to-transparent">
      ...
      <Card hoverEffect={false} padding="lg" className="w-full max-w-md space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-text-primary">Sign in to CollegeConnect</h2>
          <p className="text-xs text-text-secondary">Enter credentials or choose a quick demo template</p>
        </div>
        ...
        <div className="flex bg-white/5 border border-white/10 dark:border-white/5 rounded-xl p-1">
          <button
            ...
            className={`flex-1 py-2 text-xs font-semibold rounded-lg transition-colors cursor-pointer ${role === 'student' ? 'bg-brand text-white' : 'text-text-secondary hover:text-text-primary'}`}
          >
            Student Account
          </button>
          <button
            ...
            className={`flex-1 py-2 text-xs font-semibold rounded-lg transition-colors cursor-pointer ${role === 'faculty' ? 'bg-brand text-white' : 'text-text-secondary hover:text-text-primary'}`}
          >
            Faculty Account
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-center">
              ...
              <a href="#" onClick={(e) => {e.preventDefault(); alert("Password recovery is disabled in demo mode.");}} className="text-[11px] text-brand hover:underline">Forgot password?</a>
            </div>
            <div className="relative flex items-center">
              ...
              <button
                ...
                className="absolute right-3 p-1 rounded-lg text-text-secondary hover:text-text-primary cursor-pointer"
              >
          ...
          <div className="flex items-center">
            <input
              ...
              className="w-4 h-4 rounded border-white/15 text-brand focus:ring-brand/40 bg-white/5 cursor-pointer"
            />
            <label htmlFor="remember" className="ml-2 text-xs font-medium text-text-secondary cursor-pointer selection:bg-transparent">
              Remember my session
            </label>
          </div>
        ...
        <div className="relative flex py-2 items-center">
          ...
          <span className="flex-shrink mx-4 text-text-secondary text-[10px] uppercase font-bold tracking-wider">Quick Demo Login</span>
          <div className="flex-grow border-t border-white/10"></div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <button 
            ...
            className="flex items-center justify-center gap-2 py-2 px-3 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 text-xs font-medium text-text-primary cursor-pointer transition-colors"
          >
