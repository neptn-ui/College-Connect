          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <Card hoverEffect={true} padding="sm" className="flex items-center gap-4">
              ...
              <div>
                ...
                <span className="text-2xl font-extrabold text-text-primary block mt-0.5">{totalStudents}</span>
              </div>
            </Card>
            ...
            <Card hoverEffect={true} padding="sm" className="flex items-center gap-4">
              ...
              <div>
                ...
                <span className="text-2xl font-extrabold text-text-primary block mt-0.5">{pendingSubmissions} Submissions</span>
              </div>
            </Card>
            ...
            <Card hoverEffect={true} padding="sm" className="flex items-center gap-4">
              ...
              <div>
                ...
                <span className="text-2xl font-extrabold text-text-primary block mt-0.5">{avgGrade}%</span>
              </div>
            </Card>
            ...
            <Card hoverEffect={true} padding="sm" className="flex items-center gap-4">
              ...
              <div>
                ...
                <span className="text-2xl font-extrabold text-text-primary block mt-0.5">{myClasses.length} active</span>
              </div>
            </Card>
          </div>
